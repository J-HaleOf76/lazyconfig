...
-- This needs a require outside of here for this tobe usable
-- Im the legendary file OR folder
--
-- I think this is a seperate file for legendary.
-- Everythig has its own file.keys, commands, autocmds, etc...
-- I might need the other files for this to work with my config but
-- Theirs alot of work done here.
--
local M = {}
