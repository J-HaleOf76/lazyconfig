...
--AUTHOR: JJH
--Date: Aug 3, 2024
--Edits: I commented out a few lines for Telescope overrides
--Theme might have updated to fix these.
  opts = { theme = "darker" },
--
--]]--
...
-- Found this inside a Kanagawa config file.
-- M.supported_variants = { "wave", "dragon", "lotus" }
-- M.default_variant = "dragon"
M.supported_variants = { "darker", "wave", "dragon", "lotus" }
