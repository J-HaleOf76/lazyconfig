--[[ COPY OF THE MAIN utils FILE --]]
--
--[[ utils - This is mostly functions for common file operations
--So the local M is only a placeholder - It's an arbuary name that hold the other stuff together.
-- -I can use a function by requiring it at the top of the file. - local nvim-config = require("utils.nvim_config_base_path");
--LazyVim also has a util that can be used.
--
--]]--
local M = {}
